        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/share/1arnrrAkYM/" className="w-10 h-10 bg-primary-light rounded-lg flex items-center justify-center hover:bg-gold transition-colors">
